        ...
        render: function () {
            return (
                <div>
                    ...
                    <p>Spännande att du har funnit en annons som du vill svara på! Här hjälper vi dig att ta fram de viktigaste egenskaperna som efterfrågas i annonsen samt matcha de kraven med dina egenskaper.</p>

                    <p>Genom ett antal frågeställningar och övningar kommer du att identifiera och förklara de viktigaste egenskaper att lyfta fram i din jobbansökan.</p>
